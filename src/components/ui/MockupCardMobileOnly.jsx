...
export function MockupCardMobileOnly({ images, alt, project, onClick, className }) {
  ...
  if (!image) {
    return (
      <div className="w-full h-[35vh] min-h-[240px] max-h-[280px] -mt-[10px] bg-neutral-900 rounded-xl flex items-center justify-center">
  ...
  return (
    <div
      className={`w-full h-[35vh] min-h-[240px] max-h-[280px] -mt-[10px] relative cursor-pointer ${className || ''}`}
      style={{
